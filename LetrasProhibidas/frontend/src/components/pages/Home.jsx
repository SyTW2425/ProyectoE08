              ...
              <div className="h-full w-[50rem] flex flex-row gap-4 items-center justify-start p-3">
                ...
                <div className="flex h-full w-full items-center justify-center">
                  <div className="grid h-full w-full gap-4 p-2 grid-cols-5 grid-rows-4 rounded-lg shadow-md">
                    ...
                    >
                      <BentoItem title="PERFIL" description="Echa un vistazo a tus partidas ganadas, estadísticas y logros." background="bento/profile.png"/>
                    </div>

                    <div
                      className="col-span-3 row-span-2 rounded-lg shadow-md flex items-center justify-center"
                    >
                      <BentoItem title="JUGAR" description="¿No tienes con quién jugar? No hay problema, busca una partida y conoce gente nueva." background="bento/play.png"/>
                    </div>

                    <div
                      className="col-span-3 row-span-2 rounded-lg shadow-md flex items-center justify-center"
                    >
                      <BentoItem title="UNIRSE" description="Pide a tus amigos el código de la sala y juega junto a ellos." background="bento/join.png"/>
                    </div>

                    <div
                      className="col-span-2 row-span-2 rounded-lg shadow-md flex items-center justify-center"
                    >
                      <BentoItem title="CREAR SALA" description="Crea una sala con tus propias reglas, ¡no te olvides de invitar a tus amigos!" background="bento/create.png"/>
                    </div>
